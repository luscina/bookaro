...
public class CatalogInitializerService implements CatalogInitializerUseCase {
    ...
    private UpdateBookCoverCommand updateBookCoverCommand(Long id, String thumbnail) {
        ResponseEntity<byte[]> response = restTemplate.exchange(thumbnail, HttpMethod.GET, null, byte[].class);
        String contentType = response.getHeaders().getContentType().toString();
        return new UpdateBookCoverCommand(id, response.getBody(), contentType, "cover");
    }
